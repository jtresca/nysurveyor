...
if ( version_compare( JVERSION, '1.6.0', 'l' ) ) {
	...
	class JElementNN_TextAreaPlus extends JElement
	{
		...
		function fetchTooltip( $label, $description, &$node, $control_name, $name )
		{
			...
			return $this->_nnfield->getLabel( $control_name.'['.$name.']', $control_name.$name, $label, $description, $node->attributes(), 1 );
		}
	...
	class JFormFieldNN_TextAreaPlus extends JFormField
	{
		...
		{
			$this->_nnfield = new nnFieldTextAreaPlus();
			return $this->_nnfield->getLabel( $this->name, $this->id, (string) $this->getTitle(), $this->description, $this->element->attributes() );
		}
