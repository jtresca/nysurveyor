...
(NULL, 'System - Articles Anywhere', 'articlesanywhere', 'system', 0, 0, 1, 0, 0, 0, '0000-00-00 00:00:00', '');

--
-- Insert the editor button plugin record
--
INSERT INTO `jos_plugins` (`id`, `name`, `element`, `folder`, `access`, `ordering`, `published`, `iscore`, `client_id`, `checked_out`, `checked_out_time`, `params`) VALUES
(NULL, 'Editor Button - Articles Anywhere', 'articlesanywhere', 'editors-xtd', 0, 0, 1, 0, 0, 0, '0000-00-00 00:00:00', '');
