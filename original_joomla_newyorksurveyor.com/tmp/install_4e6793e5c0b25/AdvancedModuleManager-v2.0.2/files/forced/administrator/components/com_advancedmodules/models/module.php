	...
	*/
	...
	public function save($data)
	{
		...
		if ( isset( $advancedparams['assignto_menuitems'] ) && isset( $advancedparams['assignto_menuitems_selection'] ) ) {
			...
			if ( $advancedparams['assignto_menuitems'] == 1 && empty( $advancedparams['assignto_menuitems_selection'] ) ) {
				$data['assignment'] = '-';
	...
	public function saveAdvancedParams( $data, $id = 0 )
	{
		...
		require_once JPATH_ADMINISTRATOR.DS.'components'.DS.'com_advancedmodules'.DS.'tables'.DS.'advancedmodules.php';
		$table = JTable::getInstance( 'AdvancedModules', 'AdvancedModulesTable' );
		$table->moduleid = $id;
