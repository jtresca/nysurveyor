...
class plgSystemAdvancedModules extends JPlugin
{
	...
	function onAfterRoute()
	{
		...
		if ( !JFile::exists( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_advancedmodules'.DS.'advancedmodules.php' ) ) {
			return;
		}
...
function &plgSystemAdvancedModulesConfig()
{
	...
	if ( !is_object( $instance ) ) {
		...
		$instance = $parameters->getParams( $config->toObject(), JPATH_ADMINISTRATOR.DS.'components'.DS.'com_advancedmodules'.DS.'config.xml' );
	}
	return $instance;
}
