...
if ( in_array( 'com', $types ) ) {
	if ( JFile::exists( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_'.$ext.DS.'com_'.$ext.'.xml' ) ) {
		$xml = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_'.$ext.DS.'com_'.$ext.'.xml';
	} else if ( JFile::exists( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_'.$ext.DS.$ext.'.xml' ) ) {
...
if ( in_array( 'mod', $types ) ) {
	if ( JFile::exists( JPATH_ADMINISTRATOR.DS.'modules'.DS.'mod_'.$ext.DS.'mod_'.$ext.'.xml' ) ) {
