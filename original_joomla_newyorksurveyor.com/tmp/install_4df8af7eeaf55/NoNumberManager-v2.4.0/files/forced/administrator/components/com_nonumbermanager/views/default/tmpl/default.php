...
$document->addScript( JURI::root( true ).'/administrator/components/com_nonumbermanager/js/script.js' );
$script = "
...
?>
<p></p>
<form action="<?php echo JRoute::_( str_replace( '&page=licenses', '', $this->request_url ) ) ?>" method="post" name="adminForm" id="adminForm">
	<table id="nonumbermanager_table" class="adminlist nonumbermanager<?php if ( $config->get( 'hide_notinstalled', 0 ) ) { echo ' hidenotinstalled'; } ?>">
		<thead>
			...
			<tr>
				...
				<th width="20">&nbsp;</th>
				<th width="20">&nbsp;</th>
				<th width="50"><?php echo JText::_( 'JVERSION' ); ?></th>
...
<?php
	$xml = JApplicationHelper::parseXMLInstallFile( JPATH_SITE.str_replace( '/', DS, '/plugins/system/nonumberelements/nonumberelements.xml' ) );
