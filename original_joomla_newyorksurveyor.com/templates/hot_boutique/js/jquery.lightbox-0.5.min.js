 ...
 */
(function(jQuery){jQuery.fn.lightBox=function(settings){settings=jQuery.extend({overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'templates/hot_boutique/images/lightbox-ico-loading.gif',imageBtnPrev:'templates/hot_boutique/images/lightbox-btn-prev.gif',imageBtnNext:'templates/hot_boutique/images/lightbox-btn-next.gif',imageBtnClose:'templates/hot_boutique/images/lightbox-btn-close.gif',imageBlank:'templates/hot_boutique/images/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
